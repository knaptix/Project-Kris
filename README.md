...
- `styles.css` — premium dark-green football-inspired visual system, interaction states, and responsive layout.
- `app.js` — lightweight scroll progress, reveal animations, and accessible community tabs.
